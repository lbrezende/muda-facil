    ...
    <section className="w-full px-6 py-20 bg-white border-t">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12 max-w-6xl mx-auto">
        <div>
          ...
          <Link href="/login">
            <button className={cn(
              "bg-[#009B3A] text-white font-semibold py-3 px-6 rounded-lg text-base",
              "transition-all hover:bg-[#007A2E] active:scale-95",
              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#009B3A] focus-visible:ring-offset-2",
