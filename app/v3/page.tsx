        ...
        <div className="flex items-center gap-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/login">
              <Button
                size="sm"
                className="rounded-full bg-primary hover:bg-primary/90 text-white text-sm font-medium px-5"
              >
                Comecar gratis
              </Button>
            </Link>
          ...
          <div className="max-w-[567px]">
            ...
            <div className="mt-8 flex items-center gap-3">
              <Link href="/login">
                <Button
                  size="lg"
                  className="rounded-full bg-primary hover:bg-primary/90 text-white px-7 h-12 text-base font-semibold"
                >
    ...
    <section className="bg-white py-24">
      <div className="mx-auto max-w-[820px] px-6">
        <h2 className="text-[40px] font-bold leading-[1.2] tracking-tight text-[#1A1A1A]">
          ...
          <span className="italic text-primary">sem surpresas</span>
        </h2>
      </div>
    </section>
  );
