    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="grid gap-8 md:grid-cols-2 max-w-2xl mx-auto">
          ...
          {/* PRO Plan */}
          <Card className="relative border-[#009B3A] border-2">
            ...
            <CardContent className="space-y-3">
              ...
              <Button
                className="w-full mt-4 bg-[#009B3A] hover:bg-[#007A2E]"
...
function Feature({ text, highlight }: { text: string; highlight?: boolean }) {
  return (
    <div className="flex items-center gap-2">
      <Check className={`h-4 w-4 shrink-0 ${highlight ? "text-[#009B3A]" : "text-gray-400"}`} />
