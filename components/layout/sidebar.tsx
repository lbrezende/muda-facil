      ...
      >
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-4">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-md bg-[#009B3A] text-white">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-md px-2 py-1 text-sm tracking-[-0.084px] transition-colors ${
                    isActive
                      ? "bg-[#E6F5EC] font-semibold text-[#009B3A]"
          ...
          <div className="border-t border-[#E5E9EB] px-4 py-3">
            <div className="flex items-center gap-2">
              <Avatar className="h-8 w-8">
                ...
                />
                <AvatarFallback className="bg-[#E6F5EC] text-xs font-semibold text-[#009B3A]">
                  {session.user.name
                    ?.split(" ")
                    .map((n) => n[0])
                    .join("")
